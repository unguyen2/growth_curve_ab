...
new <- select(LK135_ab, 1,4,5,8,9,12,13,16,17,21,22)
new1 <- select(LK369_ab, 1,4,5,8,9,12,13,16,17,21,22)
new2 <- select(DMSO_ab, 1,4,5,8,9,12,13,16,17,21,22)
...
mean <- select(LK135_ab, 1, 4,8,12,16,21)
#melting mean data 
